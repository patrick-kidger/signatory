...
.. warning::
    ...
    If repeatedly making forward and backward passes, for example when training a neural network, then make sure to construct a new :class:`signatory.Path` object for each forward pass.
